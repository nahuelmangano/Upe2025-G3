...
export class ProblemasComponent implements OnInit, OnDestroy {
  ...
  nuevo(): void { this.router.navigate(['/medico', 'paciente', this.pacienteId, 'problemas', 'nuevo']); }
  verEvoluciones(): void { this.router.navigate(['/medico', 'paciente', this.pacienteId, 'evoluciones']); }
