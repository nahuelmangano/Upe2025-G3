...
export class ModalPermisoRecepcionistaComponent {
  ...
  constructor(
    private modalActual: MatDialogRef<ModalPermisoRecepcionistaComponent>,
  ...
  guardarEditarRolPermiso() {
    {
       ...
       const valorActivo = this.formularioPermiso.value.activo;
      ...
      const _rolPermiso: RolPermiso = {
        ...
        activo: this.datosRolPermiso == null ? true : valorActivo === 1
      };
