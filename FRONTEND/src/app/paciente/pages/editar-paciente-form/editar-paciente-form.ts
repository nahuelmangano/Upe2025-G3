...
import { PacienteObraSocialService } from 'src/app/services/paciente-obra-social.service';

import { GeoDataService, Pais, Provincia } from '../../../services/geo-data.service';

import { ModalDomicilioComponent } from '../../../components/layout/modals/modal-domicilio/modal-domicilio.component';
import { ModalObraSocialComponent } from '../../../components/layout/modals/modal-obra-social/modal-obra-social.component';
...
export class EditarPacienteFormComponent {
          ...
          this._pacienteObraSocialServicio.editar(relacionEditar).subscribe({
            next: (resp: ResponseApi) => {
              if (resp.estado) {
                ...
                setTimeout(() => this.router.navigate(['/pages/recepcionista/pacientes']).then(() => {
  ...
  cancelarGuardarPaciente(): void {
    this.router.navigate(['/pages/recepcionista/pacientes']).then(() => {
      this.scroller.scrollToPosition([0, 0]);
    })
  }
}
